    ...
    (function (M, ha) {
        ...
        function yg(a, b, c) {
            ...
            oe ||
                ...
                ($b && Zb($b, d)) ||
                    (($b = d),
                    (d = Tc(pe, "onSelect")),
                    0 < d.length && ((b = new le("onSelect", "select", null, b, c)), a.push({ event: b, listeners: d }), (b.target = qb))));
        }
        function zg(a, b, c) {
        ...
        function Tc(a, b) {
            for (var c = b + "Capture", d = []; null !== a; ) {
                ...
                5 === e.tag &&
                    null !== f &&
                    ((e = f), (f = Pb(a, c)), null != f && d.unshift(ac(a, f, e)), (f = Pb(a, b)), null != f && d.push(ac(a, f, e)));
                a = a.return;
            }
            return d;
        }
        ...
        function Mg(a, b, c, d, e) {
            for (var f = b._reactName, g = []; null !== c && c !== d; ) {
                ...
                5 === h.tag &&
                    null !== v &&
                    ((h = v),
                    e ? ((k = Pb(c, f)), null != k && g.unshift(ac(c, k, h))) : e || ((k = Pb(c, f)), null != k && g.push(ac(c, k, h))));
                c = c.return;
            }
        ...
        function cc(a, b, c, d) {
            ...
            if (null !== f) {
                ...
                do {
                    ...
                    if ((d & h) === h) {
                        null !== m &&
                            (m = m.next = { eventTime: r, lane: 0, tag: f.tag, payload: f.payload, callback: f.callback, next: null });
                        a: {
                            var n = a,
                                t = f;
                            h = b;
        ...
        function zh(a, b, c, d, e, f) {
            ...
            g = a.child;
            if (0 === (e & f) && ((e = g.memoizedProps), (c = c.compare), (c = null !== c ? c : Zb), c(e, d) && a.ref === b.ref))
                return sa(a, b, f);
            b.flags |= 1;
            a = Ma(g, d);
            a.ref = b.ref;
        ...
        function Ch(a, b, c, d, e) {
            ...
            yb(b, e);
            if (null === b.stateNode)
                null !== a && ((a.alternate = null), (b.alternate = null), (b.flags |= 2)), fh(b, c, d), Ce(b, c, d, e), (d = !0);
            else if (null === a) {
                var g = b.stateNode,
                    h = b.memoizedProps;
                g.props = h;
        ...
        function Eh(a, b, c) {
            ...
            g
                ? ((f = !0), (b.flags &= -65))
                : (null !== a && null === a.memoizedState) || void 0 === d.fallback || !0 === d.unstable_avoidThisFallback || (e |= 1);
            A(E, e & 1);
            if (null === a) {
                ...
                if ("number" === typeof d.unstable_expectedLoadTime)
                    return (
                        (a = Fh(b, a, e, c)), (b.child.memoizedState = { baseLanes: c }), (b.memoizedState = qd), (b.lanes = 33554432), a
                    );
            ...
            switch (c.tag) {
                ...
                case 13:
                    null === c.memoizedState &&
                        ((c = c.alternate), null !== c && ((c = c.memoizedState), null !== c && ((c = c.dehydrated), null !== c && bg(c))));
                    return;
                case 19:
                case 17:
                case 20:
        ...
        function af(a, b, c) {
            ...
            else if (4 !== d && ((a = a.child), null !== a)) for (af(a, b, c), a = a.sibling; null !== a; ) af(a, b, c), (a = a.sibling);
        }
        function bf(a, b, c) {
            var d = a.tag,
                e = 5 === d || 6 === d;
        ...
        var w = 8,
            ...
            Cd = B({}, yc, {
                ...
                movementX: function (a) {
                    ...
                    a !== zc &&
                        (zc && "mousemove" === a.type ? ((wf = a.screenX - zc.screenX), (xf = a.screenY - zc.screenY)) : (xf = wf = 0),
                        (zc = a));
                    return wf;
                },
